...
import { Mail, Lock, User, Phone, Loader2, Eye, EyeOff, MessageSquare } from 'lucide-react';
            ...
            <form onSubmit={handleSubmit} className="space-y-4 mt-4">
              ...
              <div className="flex items-start gap-3">
                <input
                  ...
                  className="mt-1 h-4 w-4 rounded border-input accent-emerald"
                />
                <label htmlFor="smsOptIn" className="text-sm text-muted-foreground leading-snug">
                  <MessageSquare className="inline h-4 w-4 mr-1 -mt-0.5" />
                  I agree to receive order updates and delivery notifications via SMS.
                  Message frequency varies. Msg &amp; data rates may apply. Reply STOP to opt out.{' '}
                  <Link href="/sms-consent" className="text-emerald hover:underline" target="_blank">
                    SMS Terms
                  </Link>
                </label>
              </div>
